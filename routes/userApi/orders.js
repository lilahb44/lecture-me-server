...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    const orders = await asyncQuery(
      `select o.id, g.name AS groupName, CONCAT(l.firstName," ",l.lastName) AS lecturer, o.address, o.date, IF(o.status=1,"Accept", IF(o.status=0,"Decline", null)) as status, o.price
      from orders o
